...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Prepare SQL statement to fetch user data based on username or email and role
    $stmt = $pdo->prepare("SELECT * FROM users WHERE (username = ? OR email = ?) AND (role = 'staff' OR role = 'admin')");
